...
- 🐛 [Report Bugs](https://github.com/neardaniel-pls/fedora-system-setup/issues/new?template=bug_report.md)
- 💡 [Request Features](https://github.com/neardaniel-pls/fedora-system-setup/issues/new?template=feature_request.md)
